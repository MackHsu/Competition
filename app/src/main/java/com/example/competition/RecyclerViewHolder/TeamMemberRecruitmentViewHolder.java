...
public class TeamMemberRecruitmentViewHolder extends BaseViewHolder {

    XUILinearLayout xuiLinearLayout;

    public TeamMemberRecruitmentViewHolder(@NotNull View view) {
        super(view);
        xuiLinearLayout = view.findViewById(R.id.team_xui_layout);
