...
public class DiscussListViewHolder extends BaseViewHolder {

    private XUILinearLayout xuiLinearLayout;

    public DiscussListViewHolder(@NotNull View view) {
        super(view);
        xuiLinearLayout = view.findViewById(R.id.discuss_list_item_xui_layout);
