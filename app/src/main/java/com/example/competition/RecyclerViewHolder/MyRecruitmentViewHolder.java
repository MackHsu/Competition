...
public class MyRecruitmentViewHolder extends BaseViewHolder {

    private XUILinearLayout xuiLinearLayout;

    public MyRecruitmentViewHolder(@NotNull View view) {
        super(view);
        xuiLinearLayout = view.findViewById(R.id.my_recruitment_xui_layout);
