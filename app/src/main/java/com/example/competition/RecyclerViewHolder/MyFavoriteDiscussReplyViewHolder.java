...
public class MyFavoriteDiscussReplyViewHolder extends BaseViewHolder {

    private XUILinearLayout xuiLinearLayout;

    public MyFavoriteDiscussReplyViewHolder(@NotNull View view) {
        super(view);
        xuiLinearLayout = view.findViewById(R.id.my_favorite_discuss_reply_xui_layout);
