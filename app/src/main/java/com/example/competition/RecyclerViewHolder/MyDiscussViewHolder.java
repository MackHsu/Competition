...
public class MyDiscussViewHolder extends BaseViewHolder {

    private XUILinearLayout xuiLinearLayout;

    public MyDiscussViewHolder(@NotNull View view) {
        super(view);
        xuiLinearLayout = view.findViewById(R.id.my_discuss_xui_layout);
